...
Script Purpose:
    ...
    In performs the following actions:
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM 'C:\Users\dell\Desktop\SQL\datasets\source_crm\cust_info.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\Users\dell\Desktop\SQL\datasets\source_crm\prd_info.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\Users\dell\Desktop\SQL\datasets\source_crm\sales_details.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\Users\dell\Desktop\SQL\datasets\source_erp\LOC_A101.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\Users\dell\Desktop\SQL\datasets\source_erp\CUST_AZ12.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\Users\dell\Desktop\SQL\datasets\source_erp\PX_CAT_G1V2.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
